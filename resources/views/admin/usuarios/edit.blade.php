    ...
    <div class="row">
      <div class="col l4">
        <div class="input-field">
          ...
          {!! Form::text('name', $usuario->name, ['class'=>'validate','required']) !!}
        </div>      
      </div>
      ...
      <div class="col l4">
        <div class="input-field">
          ...
          {!! Form::text('last_name', $usuario->last_name, ['class'=>'validate','required']) !!}
        </div>
      </div>
      ...
      <div class="col l4">
        <div class="input-field">
          ...
          {!! Form::text('second_name', $usuario->second_name, ['class'=>'validate','required']) !!}
        </div>
      </div>
